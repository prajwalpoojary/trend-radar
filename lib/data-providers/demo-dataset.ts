...
// Manually logged for this demo while watching #UdupiKrishna / #Janmashtami2026
// public hashtags — NOT scraped, NOT pulled from a live API. See README/ARCHITECTURE
// for exactly why, and what's required to replace this with real data.
export const JANMASHTAMI_DEMO_DATA: ContentItem[] = [
  {
    id: "r1",
